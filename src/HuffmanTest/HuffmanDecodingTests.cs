...
namespace HuffmanTest
{
    public class HuffmanDecodingTests
    {
        ...
        private static DecodeDelegate GetDecodeDelegate()
        {
            ...
            Type huffmanType = typeof(Huffman); // assembly.GetType("System.Net.Http.HPack.Huffman");
        ...
        public static (ulong code, int bitLength) GetEncodedValue(byte b)
        {
        ...
        private static readonly Type s_huffmanDecodingExceptionType = typeof(HuffmanDecodingException);
        ...
        public static IEnumerable<object[]> InvalidEncodingData()
        {
            ...
            // TODO: send combinations with EOS in the middle
