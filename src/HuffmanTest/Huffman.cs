...
namespace HuffmanTest
{
    ...
    {
        delegate int DecodeImplementation(uint data, int validBits, out int decodedBits);
        ...
        public enum DecodingMethod { Loop, LoopWithCodeMax, Dictionary }
        ...
        public static readonly (int codeLength, int[] codes)[] s_decodingTable = new[]
        {
        ...
        public static readonly (int codeLength, int codeMax, int[] codes)[] s_decodingTableWithCodeMax = new[]
        {
        ...
        public static int Decode(byte[] src, int offset, int count, byte[] dst, DecodingMethod decodeMethod)
        {
            DecodeImplementation impl = null;
            switch (decodeMethod)
            {
                case DecodingMethod.Loop:
                    impl = DecodeWithLoop;
                    break;
                case DecodingMethod.LoopWithCodeMax:
                    impl = DecodeWithLoopAndCodeMax;
                    break;
                case DecodingMethod.Dictionary:
                    impl = DecodeWithDictionary;
                    break;
            }
            ...
            while (i < count)
            {
                ...
                int decodedBits = 0;
                int ch = impl(next, validBits, out decodedBits);
                //switch (decodeMethod)
                //{
                //    case DecodingMethod.Dictionary:
                //        ch = DecodeWithDictionary(next, validBits, out decodedBits);
                //        break;
                //    case DecodingMethod.Loop:
                //        ch = DecodeWithLoop(next, validBits, out decodedBits);
                //        break;
                //    case DecodingMethod.LoopWithCodeMax:
                //        ch = DecodeWithLoopAndCodeMax(next, validBits, out decodedBits);
                //        break;
                //}
        ...
        public static int DecodeWithLoop(uint data, int validBits, out int decodedBits)
        {
        ...
        public static int DecodeWithLoopAndCodeMax(uint data, int validBits, out int decodedBits)
        {
            ...
            for (int i = 0; i < s_decodingTableWithCodeMax.Length && s_decodingTableWithCodeMax[i].codeLength <= validBits; i++)
            {
                (int codeLength, int codeMax, int[] codes) = s_decodingTableWithCodeMax[i];
        ...
        public static int DecodeWithDictionary(uint data, int validBits, out int decodedBits)
        {
