...
namespace HuffmanTest
{
    ...
    public static class HuffmanOrig
    {
        ...
        {
            (05, new[] { 48, 49, 50, 97, 99, 101, 105, 111, 115, 116 }),
            (06, new[] { 32, 37, 45, 46, 47, 51, 52, 53, 54, 55, 56, 57, 61, 65, 95, 98, 100, 102, 103, 104, 108, 109, 110, 112, 114, 117 }),
            (07, new[] { 58, 66, 67, 68, 69, 70, 71, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 83, 84, 85, 86, 87, 89, 106, 107, 113, 118, 119, 120, 121, 122 }),
            (08, new[] { 38, 42, 44, 59, 88, 90 }),
